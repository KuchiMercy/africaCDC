...
const Header = () => {
  return (
    <>
      ...
      >
       <div className="flex justify-center md:block"> <img src={logo} alt="" className="w-[250px] absolute z-[100000]" /></div>
      ...
      <div className="absolute top-0 left-0 bg-black w-full h-[100dvh] md:h-[500px] z-[10000] !opacity-40 md:!opacity-30"></div>
    </>
  );
};
