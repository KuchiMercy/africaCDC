  ...
  return (
    <>
      <header
        ...
        className="bg-cover bg-center md:bg-fixed max-w-[100%] w-full h-[600px] md:h-[500px] relative"
      >
      ...
      <div className="absolute top-0 left-0 bg-black w-full h-[600px] md:h-[500px] z-[10000] !opacity-30"></div>
    </>
  );
};
